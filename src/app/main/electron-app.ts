...
import { KolorsService } from '../services/kolors/KolorsService';
...
export class ElectronApp {
    ...
    public get metaSchemaService() {
        return this.iocContext.getBean<MetaSchemaService>(
            MetaSchemaService.name,
        );
    }
